...
class UserController {
  async create(req, res) {
    ...
    const userData = await Users.create({ email, password: await encryptPassword(password), username });
  ...
  async update(req, res) {
    ...
    const userData = await Users.findByIdAndUpdate(userId, { email, password: await encryptPassword(password), username });
